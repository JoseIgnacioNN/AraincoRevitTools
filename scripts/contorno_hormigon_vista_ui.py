# -*- coding: utf-8 -*-
"""UI WPF — contorno de hormigón por plano de la vista activa.

Respaldo de desarrollo: sincronice con ``20_ContornoHormigonVista.pushbutton/scripts/``.
"""
...
_SINGLETON_KEY = u"Arainco_ContornoHormigonVista_UI"
_TX_GENERAR = u"Arainco: Contorno hormigón por vista"
...
_HELP_TEXT = (
    ...
    u"= Concrete con el plano de la propia vista (ViewDirection + Origin).\n\n"
    u"Las detail lines resultantes se agrupan como CONTORNO + nombre de la vista."
)
...
class ContornoHormigonVistaWindow(object):
    ...
    def _refresh_summary(self):
        ...
        self._txt_subtitle.Text = (
            ...
            u"Plano de corte: el generado por esta vista.".format(vname, n)
        )
...
def show_contorno_window(revit):
    ...
    win = ContornoHormigonVistaWindow(uiapp)
    try:
