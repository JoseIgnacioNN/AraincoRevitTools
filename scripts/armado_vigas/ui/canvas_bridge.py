...
def _beam_to_canvas_dict(beam, index):
    ...
    out = {
        ...
        "supleSupEnabled": bool(beam.get("supleSupEnabled")),
        "supleSupStartEnabled": bool(beam.get("supleSupStartEnabled", True)),
        "supleSupEndEnabled": bool(beam.get("supleSupEndEnabled", True)),
        "diamSupleSup": int(beam.get("diamSupleSup") or 16),
        "nSupleSup": int(beam.get("nSupleSup") or 2),
        "colStart": beam.get("colStart") or u"",
        "colEnd": beam.get("colEnd") or u"",
        "axisReversed": bool(beam.get("axisReversed")),
    }
