# -*- coding: utf-8 -*-
"""Abre el Manual de inicio de proyecto (Arainco) en el navegador.
...
_MANUAL_NAME = u"manual_inicio_proyecto.html"
_DIALOG_TITLE = u"Arainco: Manual inicio de proyecto"
    ...
    for _ in range(16):
        for rel in (
            os.path.join(
                "BIMTools.tab",
                "Estandares.panel",
                "02_ManualInicioProyecto.pushbutton",
                _MANUAL_NAME,
            ),
            os.path.join("Estandares.panel", "02_ManualInicioProyecto.pushbutton", _MANUAL_NAME),
        ):
