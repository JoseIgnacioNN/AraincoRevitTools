# -*- coding: utf-8 -*-
"""Diálogo modal WPF (tema oscuro BIMTools) — Armado Columnas, estilo Armado Muros."""
...
_DIALOG = u"Arainco: Armado Columnas"
...
def show_ok_cancel_dialog(
    ...
    """Muestra un diálogo modal estilo BIMTools. ``True`` si confirma."""
    try:
...
def show_selection_instructions(uiapp=None):
    ...
    return show_ok_cancel_dialog(
        _DIALOG,
        u"Seleccione una o más columnas estructurales para armar.",
        u"La herramienta abrirá un asistente para configurar la rejilla, "
        u"troceo y parámetros. Generará barras longitudinales, estribos y el "
        u"croquis de despiece en la vista activa.\n\n"
