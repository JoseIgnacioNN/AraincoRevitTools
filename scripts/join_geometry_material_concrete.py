# -*- coding: utf-8 -*-
"""
Detección de material estructural hormigón (Concrete).

Extraído de ``geometria_colision_vigas``. Usado por
``join_geometry_concrete_vista`` (y consumidores que filtren hormigón estructural).
"""
