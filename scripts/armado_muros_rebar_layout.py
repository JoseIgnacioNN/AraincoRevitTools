# -*- coding: utf-8 -*-
"""
Utilidades de layout/extremos Rebar para Armado Muros (v3 y afines).

Sin dependencias de pyrevit ni area_reinforcement_losa.
``armado_muros_nodo_shared`` permanece para Armado Muros Nodo.
"""
