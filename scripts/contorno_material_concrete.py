...
def crear_options_geometria(view=None):
    """``Options`` para extracción de sólidos; opcionalmente acotada a una vista."""
    options = Options()
...
def obtener_solidos_elemento(elemento, options=None, view=None):
    """
