# -*- coding: utf-8 -*-
"""Enfierrado fundaciones aisladas — UI y selección; lógica de barras pendiente."""

__title__ = u"Fundación\nAislada"
...
_TOOL_DIALOG_TITLE = u"Armadura Fundacion Aislada"


def _find_module(start_dir):
    cursor = start_dir
    for _ in range(10):
        candidate = os.path.join(cursor, "scripts", "enfierrado_fundacion_aislada.py")
...
if not _module_path:
    TaskDialog.Show(
        _TOOL_DIALOG_TITLE,
        u"No se encontró scripts/enfierrado_fundacion_aislada.py",
    )
