# -*- coding: utf-8 -*-
"""
Cargar familias desde carpeta — entrada pyRevit (copia portable).
...
__doc__ = (
    u"Selecciona una carpeta en Windows y carga todas las familias (.rfa) "
    u"encontradas. Si una familia ya existe en el proyecto, se sobrescribe "
    u"con la versión de la carpeta."
)
...
_DIALOG_TITLE = u"Arainco: Cargar familias desde carpeta"
_MAIN_MODULE = u"cargar_familias_carpeta.py"
_MAIN_MODULE_ID = u"cargar_familias_carpeta"
