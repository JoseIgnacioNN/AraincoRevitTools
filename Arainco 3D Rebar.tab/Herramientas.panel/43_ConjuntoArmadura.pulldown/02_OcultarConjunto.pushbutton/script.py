# -*- coding: utf-8 -*-
"""
Arainco: Ocultar conjunto de armadura por GUID de creación.
...
__doc__ = (
    u"Oculta en la vista activa uno o más conjuntos de armadura identificados "
    u"por «Armadura_Conjunto_GUID» a partir de barras, empalmes o croquis "
    u"(selección múltiple con Finish)."
)
...
_DIALOG_TITLE = u"Arainco: Ocultar conjunto"
_MAIN_MODULE = u"run.py"
_MAIN_MODULE_ID = u"conjunto_armadura_ocultar_run"
_RELOAD_PREFIXES = (
    _MAIN_MODULE_ID,
    "run",
    "lib",
...
if not _scripts_dir:
    ...
    raise Exception(u"No se encontró módulo principal de Ocultar Conjunto")
