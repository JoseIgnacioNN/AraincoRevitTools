# -*- coding: utf-8 -*-
"""Seleccionar Capa — entrada pyRevit; lógica en scripts/seleccionar_capa_armadura.py."""

__title__ = u"Seleccionar\nCapa"
__author__ = u"BIMTools"
__doc__ = (
    u"Selecciona barras (Rebar) y Detail Items de la misma capa "
    u"(«Armadura_Capa») que compartan el mismo «Armadura_Conjunto_GUID», "
    u"más las etiquetas de esas barras en la vista activa."
)
...
_TOOL_DIALOG_TITLE = u"Arainco: Seleccionar capa"
_MAIN_MODULE = u"seleccionar_capa_armadura.py"
_MAIN_MODULE_ID = u"seleccionar_capa_armadura"
