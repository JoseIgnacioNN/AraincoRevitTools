# -*- coding: utf-8 -*-
"""Filtro Armadura Eje — entrada pyRevit; lógica en scripts/filtro_armadura_eje.py."""

__title__ = u"Filtro\nArmadura Eje"
__author__ = u"BIMTools"
__doc__ = (
    u"Recorre todas las vistas Building Section del proyecto. En las que "
    u"tienen Armadura_Eje con valor, crea o actualiza un filtro Not Equals "
    u"sobre Structural Rebar y lo aplica con visibilidad apagada. Solo quedan "
    u"visibles las barras del eje de cada sección. Quita filtros Armadura_Eje "
    u"previos de cada vista procesada."
)
...
_TOOL_DIALOG_TITLE = u"Arainco: Filtro Armadura Eje"
_MAIN_MODULE = "filtro_armadura_eje.py"
_MAIN_MODULE_ID = "filtro_armadura_eje"
