# -*- coding: utf-8 -*-
"""Rebar Section Tag — entrada pyRevit; lógica en scripts/rebar_section_tag.py."""

__title__ = u"Rebar\nSection Tag"
__author__ = u"BIMTools"
__doc__ = (
    u"Selecciona uno o más Rebar / RebarInSystem cuyo eje no es paralelo al "
    u"plano de la vista activa y coloca una etiqueta multihost por set "
    u"(Merge Leaders), con posición automática respecto a cada elemento."
)
...
_TOOL_DIALOG_TITLE = u"Arainco: Rebar Section Tag"
_MAIN_MODULE = "rebar_section_tag.py"
_MAIN_MODULE_ID = "rebar_section_tag"
