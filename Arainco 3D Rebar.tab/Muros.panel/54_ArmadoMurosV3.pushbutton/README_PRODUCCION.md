...
- Herramienta: Armado\nMuros v3
- Salida: `54_ArmadoMurosV3.pushbutton` (solo pushbutton; sin arbol pyRevit de extension)
...
## Rebuild
  ...
  o: python _tools/prod_builder/build_dist.py --tool "…\54_ArmadoMurosV3.pushbutton"
