# -*- coding: utf-8 -*-
"""
Orientación muro en alzado — entrada pyRevit (copia portable).
...
__title__ = u"Orientación\nmuro alzado"
__author__ = u"BIMTools"
__doc__ = (
    u"Dibuja flechas verdes centradas a mitad de altura de cada muro visible "
    u"en una vista Building Section. Flecha = Location Line (0→1). "
    u"Actualizable mientras el formulario permanece abierto."
)
...
_DIALOG_TITLE = u"Arainco: Helpers orientación muro en alzado"
_MAIN_MODULE = u"orientacion_muro_alzado.py"
_MAIN_MODULE_ID = u"orientacion_muro_alzado"
_REQUIRED_MODULES = (
    _MAIN_MODULE,
    u"orientacion_muro_alzado_ui.py",
...
_MODULES_TO_PURGE = (
    _MAIN_MODULE_ID,
    u"orientacion_muro_alzado",
    u"orientacion_muro_alzado_ui",
    u"bimtools_wpf_dark_theme",
    u"bimtools_ui_tokens",
    u"bimtools_wpf_shell",
    u"revit_wpf_window_position",
    u"corporate_access",
    u"bimtools_script_guard",
    u"bimtools_instruction_dialog",
)
