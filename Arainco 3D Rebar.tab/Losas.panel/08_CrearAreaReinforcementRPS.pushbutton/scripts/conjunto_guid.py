# -*- coding: utf-8 -*-
"""
GUID de corrida (``Armadura_Conjunto_GUID``) — vendor portable.

Copia mínima de ``scripts/conjunto_guid`` / FloorGeometryCanvas sin depender
de otros pushbuttons.
"""
...
_APPDOMAIN_CONJUNTO_GUID_KEY = u"Arainco_AreaReinforcementLosa_Conjunto_GUID"
