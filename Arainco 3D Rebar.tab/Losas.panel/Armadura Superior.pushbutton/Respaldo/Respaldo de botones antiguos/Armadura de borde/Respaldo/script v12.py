...
# ===================================================================================
        ...
        l1 = e - 2 * rec # Largo 1 del gancho
        l2 = UnitUtils.ConvertToInternalUnits(15, UnitTypeId.Centimeters) # Largo 2 del gancho
        ...
        if estado.barra_izq == True:
            ...
            pt1 = end - plane_normal * l1 # Tramo 1 del gancho
            pt2 = pt1 + v_bar_3D * l2 # Tramo 2 del gancho
