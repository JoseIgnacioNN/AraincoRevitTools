...
# ===================================================================================
        ...
        if estado.barra_izq == True:
            ...
            end = p1_3D + v_bar_3D * offset_lateral # Extremo final de la barra
            gancho_izq = None
            gancho_der = gancho
        else:
            start = p1_3D - v_bar_3D * offset_lateral
            end = p1_3D - v_bar_3D * (L + Lext)
            gancho_izq = gancho
            gancho_der = None

        curves = [DB.Line.CreateBound(start, end)] # Los puntos que conforman la barra deben estar en una lista
