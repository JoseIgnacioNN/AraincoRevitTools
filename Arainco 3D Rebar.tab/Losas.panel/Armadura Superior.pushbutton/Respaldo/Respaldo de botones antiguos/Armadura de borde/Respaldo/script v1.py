...
while True:
    ...
    if form.action == "vano1":
        ...
        estado.L = math.ceil(estado.largo1/3/10)*10 # Redondear al centímetro superior
...
# ===================================================================================
        ...
        start = p1_3d + v_bar * L # Extremo inicial de la barra
        end = p1_3d - v_bar * 0 # Extremo final de la barra
