...
while True:
    ...
    if form.action == "aplicar":        
        ...
        # Transaction Group
        t_group = DB.TransactionGroup(doc, "ARAINCO - Armadura Superior de malla")
        t_group.Start()
...
# ===================================================================================
        ...
        sets_bar = [
        {"vano": (p1_vano1, p2_vano1), "recorrido": (p1_vano2, p2_vano2), "rebar_selected": rebar_types[estado.sel_index], "esp": UnitUtils.ConvertToInternalUnits(float(estado.esp_text), UnitTypeId.Millimeters)},
        {"vano": (p1_vano2, p2_vano2), "recorrido": (p1_vano1, p2_vano1), "rebar_selected": rebar_types[estado.sel_index2], "esp": UnitUtils.ConvertToInternalUnits(float(estado.esp_text2), UnitTypeId.Millimeters)}]
...
# ===================================================================================
        ...
        # Offset para Multi-Rebar Annotation y Tag
                ...
                offset_tag = UnitUtils.ConvertToInternalUnits(110, UnitTypeId.Centimeters)
