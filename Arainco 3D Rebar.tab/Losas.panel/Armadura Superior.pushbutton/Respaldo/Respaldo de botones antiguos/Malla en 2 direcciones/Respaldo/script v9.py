...
# ===================================================================================
        ...
        # Offset para Multi-Rebar Annotation y Tag
                offset_mra = UnitUtils.ConvertToInternalUnits(100, UnitTypeId.Centimeters)
                offset_tag = UnitUtils.ConvertToInternalUnits(205, UnitTypeId.Centimeters)
        ...
        # Multi-Rebar Annotation
                ...
                if tipo:
                    ...
                    mid_point = mid_point - v_bar_2D * (L/2 - offset_mra) # Se centra la cota al punto medio del recorrido y luego se suma el offset
        ...
        # Tag
                ...
                tag_pos = DB.XYZ(centro_barra.X, centro_barra.Y, Z_elev) - v_bar_2D * (L/2 - offset_tag)
