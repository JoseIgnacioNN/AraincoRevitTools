...
while True:
    ...
    if form.action == "aplicar":
        try: p1_vano, p2_vano, p1, p2 = seleccionar_puntos()
...
# ===================================================================================
        ...
        mid_point = (p1_vano + p2_vano) / 2 # Punto matemático central del recorrido
...
# ===================================================================================
    ...
    # Multi-Rebar Annotation
            ...
            if tipo:
                ...
                mid_point = (p1_vano + p2_vano) / 2 # Se centra la cota al punto medio del recorrido
