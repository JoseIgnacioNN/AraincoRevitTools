...
while True:
    ...
    if form.action == "vano":
        try: p1_vano, p2_vano = seleccionar_puntos()
        except OperationCanceledException: continue
        estado.largo = UnitUtils.ConvertFromInternalUnits(((p2_vano.X - p1_vano.X) ** 2 + (p2_vano.Y - p1_vano.Y) ** 2) ** 0.5, UnitTypeId.Millimeters)
...
# ===================================================================================
        ...
        # v_vano_2D = (p2_vano - p1_vano).Normalize()
