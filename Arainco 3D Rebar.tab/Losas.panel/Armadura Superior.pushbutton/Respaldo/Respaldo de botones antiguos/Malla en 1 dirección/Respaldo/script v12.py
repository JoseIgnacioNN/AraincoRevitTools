...
while True:
    ...
    if form.action == "aplicar":
        L = UnitUtils.ConvertToInternalUnits(estado.largo, UnitTypeId.Millimeters)
...
# ===================================================================================
    ...
    # Tag
        ...
        # Parámetros
            ...
            t.Commit()
            t_group.Assimilate()
            estado.largo = None # Cada vez que se aplica un recorrido, se elimina la selección del vano
