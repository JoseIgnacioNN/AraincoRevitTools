...
# ===================================================================================
rutinas_armado = ["Armadura sobre apoyo"] # Lista que se entrega al ComboBox "Rutina de Armado"
...
class Formulario(forms.WPFWindow):  # Funciones del formulario
    ...
    def __init__(self, xaml_file, datos):
        ...
        self.cmbRutina.ItemsSource = rutinas_armado # Crear ComboBox de rutinas de armado
        ...
        if 0 <= datos.rutina_index < len(rutinas_armado):
            self.cmbRutina.SelectedIndex = datos.rutina_index
    ...
    def guardar_estado(self):
        ...
        estado.rutina_index = self.cmbRutina.SelectedIndex
