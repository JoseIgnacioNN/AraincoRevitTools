...
if not view.SketchPlane or abs(view.SketchPlane.GetPlane().Normal.Z) != 1: # No es necesario crear el plano de trabajo cada vez, si ya existe
...
# Tag
        ...
        while ang_tag <= -(math.pi / 2):
            ang_tag += math.pi
        offset = UnitUtils.ConvertToInternalUnits(10, UnitTypeId.Centimeters)
