...
# ===================================================================================
        ...
        pt_min = DB.XYZ(mid_point.X - 0.328, mid_point.Y - 0.328, Z_elev - 4.9213) # Esquina inferior izquierda del pilar
        pt_max = DB.XYZ(mid_point.X + 0.328, mid_point.Y + 0.328, Z_elev + 4.9213) # Esquina superior derecha del pilar
        filtro_pilar = DB.BoundingBoxIntersectsFilter(DB.Outline(pt_min, pt_max)) # Pilar rectangular 20x20x300 cm, que que se utiliza para intersectar con la losa
