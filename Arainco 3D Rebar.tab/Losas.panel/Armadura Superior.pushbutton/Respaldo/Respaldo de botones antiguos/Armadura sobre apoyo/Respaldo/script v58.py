...
class Formulario(forms.WPFWindow):  # Funciones del formulario
    ...
    def AplicarClick(self, sender, args):
        ...
        try:
            ...
            forms.alert("Los valores de L1 y L2 deben ser números válidos.", title="Valor inválido")
            return
...
# ===================================================================================
        ...
        vdir = (p2_3d - p1_3d).Normalize() # Vector director del recorrido en 3D. Es perpendicular al eje de la barra y paralelo a la pendiente de la losa
