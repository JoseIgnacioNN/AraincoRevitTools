    ...
    def guardar_estado(self):
        ...
        if self.txtL1.Text:
            try:
                ...
                estado.L1_v1 = UnitUtils.ConvertToInternalUnits(float(self.txtL1.Text), UnitTypeId.Millimeters)
            except ValueError:
                pass
        ...
        if self.txtL2.Text:
            try:
                ...
                estado.L2_v2 = UnitUtils.ConvertToInternalUnits(float(self.txtL2.Text), UnitTypeId.Millimeters)
            except ValueError:
                pass
...
while True:
    ...
    if form.action == "vano1":
        ...
        estado.largo1_cm = UnitUtils.ConvertFromInternalUnits(largo1, UnitTypeId.Millimeters)
        estado.L1_cm = math.ceil(estado.largo1_cm/3/10)*10 # Redondear al centímetro superior
        estado.L1_v1 = UnitUtils.ConvertToInternalUnits(estado.L1_cm,UnitTypeId.Millimeters)
    ...
    if form.action == "vano2":
        ...
        estado.largo2_cm = UnitUtils.ConvertFromInternalUnits(largo2, UnitTypeId.Millimeters)
        estado.L2_cm = math.ceil(estado.largo2_cm/3/10)*10
        estado.L2_v2 = UnitUtils.ConvertToInternalUnits(estado.L2_cm,UnitTypeId.Millimeters)
        continue
...
# ===================================================================================
        ...
        # Tag
                ...
                centro_barra = DB.XYZ(centro_primera.X + (vdir.X * idx_central * esp_real), centro_primera.Y + (vdir.Y * idx_central * esp_real), Z) # Centroide de la barra central
