...
- Herramienta: Armado\nVigas
- Salida: `04_ArmadoVigas.pushbutton` (solo pushbutton; sin arbol pyRevit de extension)
...
- Modulos ofuscados: 141
- Autor: José Ignacio Núñez

## Contenido

```
04_ArmadoVigas.pushbutton/
  script.py
...
## Rebuild
  ...
  o: python _tools/prod_builder/build_dist.py --tool "…\04_ArmadoVigas.pushbutton"
