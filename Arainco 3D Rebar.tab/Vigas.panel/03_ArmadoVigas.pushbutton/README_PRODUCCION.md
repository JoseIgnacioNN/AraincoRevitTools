...
- Herramienta: Armado\nVigas
- Salida: `03_ArmadoVigas.pushbutton` (solo pushbutton; sin arbol pyRevit de extension)
...
- Modulos ofuscados: 144
- Autor: José Ignacio Núñez

## Contenido

```
03_ArmadoVigas.pushbutton/
  script.py
...
## Rebuild
  ...
  o: python _tools/prod_builder/build_dist.py --tool "…\03_ArmadoVigas.pushbutton"
