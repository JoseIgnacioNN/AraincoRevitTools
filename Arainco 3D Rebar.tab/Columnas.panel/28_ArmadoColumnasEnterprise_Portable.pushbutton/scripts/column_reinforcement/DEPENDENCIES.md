...
`column_stirrup_creator.py`, `bimtools_wpf_dark_theme.py`, `revit_wpf_window_position.py`
(mismos nombres que en la raíz canónica; sincronizar desde `BIMTools.extension/scripts/` al publicar).
