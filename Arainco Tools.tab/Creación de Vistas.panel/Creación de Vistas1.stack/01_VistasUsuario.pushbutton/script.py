# -*- coding: utf-8 -*-
"""
Arainco: Vistas por usuario — conjunto 02_TRABAJO por modelador.

Versión portable: dependencias en ``<pushbutton>/scripts/`` (vistas_por_usuario, infra).
...
if _bimtools_access.require_tool_access(__file__, __revit__, __title__):
    from bootstrap import purge_vistas_por_usuario_modules, setup_vistas_por_usuario_paths

    setup_vistas_por_usuario_paths()
    purge_vistas_por_usuario_modules()
