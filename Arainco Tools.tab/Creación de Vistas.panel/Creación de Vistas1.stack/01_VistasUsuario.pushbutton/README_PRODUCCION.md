...
- Herramienta: Arainco: Vistas por usuario
- Salida: `01_VistasUsuario.pushbutton` (solo pushbutton; sin arbol pyRevit de extension)
...
- Modulos ofuscados: 44
- Autor: José Ignacio Núñez

## Contenido

```
01_VistasUsuario.pushbutton/
  script.py
...
## Rebuild
  ...
  o: python _tools/prod_builder/build_dist.py --tool "…\01_VistasUsuario.pushbutton"
